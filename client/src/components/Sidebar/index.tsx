...
// api request to list projects
const {data:projects}=useGetProjectsQuery();

const dispatch=useAppDispatch();
const isSidebarCollapsed=useAppSelector((state)=>state.global.isSidebarCollapsed);

const sidebarClassNames=`fixed flex flex-col min-h-[100%] justify-between shadow-xl transition-all duration-300 h-full
...
// if pathname === "/" link if now for /dashboard
